...
# --- CERTIFIQUE-SE DE QUE ESTAS DUAS LINHAS ESTÃO AQUI ---
GROQ_URL = "https://api.groq.com/openai/v1/chat/completions"
SUPABASE_URL = "https://jwoyuttccrbzkgddcojn.supabase.co/rest/v1/delegacias"
# ---------------------------------------------------------

def processar_ia(chat_id, mensagem_usuario):
    """Integração com o Llama 3.1 rodando via serviço do Groq."""
    ...
    try:
        ...
        return "Desculpe, estou enfrentando instabilidades no momento. Tente novamente mais tarde."
